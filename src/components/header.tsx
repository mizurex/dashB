  ...
  export default function Header() {
    return (
      <header className="flex h-[88px] items-center justify-between border-b border-border/40 px-6 dark:border-slate-700 dark:bg-slate-800 lg:px-[32px] py-[20px] font-inter">
        {/* Left Side */}
          ...
          <div>
            <div className="flex items-center gap-[14px]">
              ...
              <div className="flex flex-col">
                <span className="text-foreground font-medium">Arthur Taylor</span>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <span className="text-xs font-medium text-muted ">Move Money</span>
